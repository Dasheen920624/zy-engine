...
const LINKS = [
  { name: "Swagger UI · OpenAPI 3.1", url: "/medkernel/swagger-ui.html", desc: "全部 Controller + DTO 文档" },
  { name: "Actuator · 健康端点", url: "/medkernel/actuator/health", desc: "JVM + 数据源 + Provider 健康" },
  { name: "Actuator · Prometheus", url: "/medkernel/actuator/prometheus", desc: "Micrometer 全量指标导出" },
...
export default function DevConsole() {
  return (
    <PageShell
      title="开发者控制台"
      description="技术快捷入口 · 仅架构师 / 信息科主任 / SRE 可见"
    >
      <Row gutter={[16, 16]}>
        {LINKS.map((l) => (
