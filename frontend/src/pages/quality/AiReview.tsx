...
export default function AiReview() {
  ...
  return (
    <PageShell
      title="AI 知识审核"
      description={
        "AI 生成 / 抽取的新知识必须经医务处人工审核才能进入指南库（生成式 AI 管理办法 §7 硬约束）"
      }
    >
      <Alert
        type="warning"
        ...
        icon={<RobotOutlined />}
        message="AI 候选必须人工审核"
        description="所有 AI 生成内容已强制标识“AI 生成”。医师确认前不进入病历也不指导真实医疗活动。"
      />
      <Table
        rowKey="id"
        dataSource={MOCK}
        ...
        {explain.data && (
          <Space direction="vertical" size="middle" style={{ width: "100%" }}>
            <Card size="small">
              ...
              <Progress
                percent={Math.round(explain.data.confidence * 100)}
            ...
            <Descriptions size="small" column={1} bordered>
              ...
              <Descriptions.Item label="训练数据范围">
                {explain.data.trainingDataRange}
              </Descriptions.Item>
