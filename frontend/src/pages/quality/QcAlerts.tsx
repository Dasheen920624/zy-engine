...
const MOCK = [
  {
    id: "1",
    title: "急诊科 4 月抗菌药使用率超阈值",
    dept: "急诊科",
    severity: "high",
    status: "remediating" as AlertStatus,
    days: 12,
  },
  {
    id: "2",
    title: "心内 PCI 术后住院日 > 8 天 7 例",
    dept: "心内科",
    severity: "medium",
      ...
      <Table
        ...
        columns={[
          ...
          { title: "责任科室", dataIndex: "dept", render: (v) => <Tag color="purple">{v}</Tag> },
          {
            title: "严重度",
            dataIndex: "severity",
            render: (v) => <Tag color={SEV[v]}>{v.toUpperCase()}</Tag>,
          },
