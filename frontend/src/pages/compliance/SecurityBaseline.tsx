...
const ITEMS = [
  { id: "1", category: "身份与认证", item: "MFA 启用", status: "满足", evidence: "已启用国密 CA + 手机短信" },
  { id: "2", category: "访问控制", item: "RBAC 最小权限", status: "满足", evidence: "5 角色 × 8 资源类型" },
  { id: "3", category: "数据加密", item: "敏感字段字段级加密", status: "满足", evidence: "SM4 + KMS 密钥轮换" },
  { id: "4", category: "数据加密", item: "传输 TLS + 国密", status: "满足", evidence: "TLS 1.3 + SM2 证书" },
  { id: "5", category: "审计", item: "审计链验签", status: "满足", evidence: "SM3 哈希链 + TSA" },
  { id: "6", category: "等保 2.0", item: "等保三级控制点 156 项", status: "缺证据", evidence: "外部测评中（W9 完成）" },
  { id: "7", category: "商密评测", item: "GM/T 0054 商密评测", status: "缺证据", evidence: "外部预审中（W9 完成）" },
];
