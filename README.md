...
| [docs/MEDKERNEL_BUSINESS_SCENARIO_DETAIL_SPEC.md](docs/MEDKERNEL_BUSINESS_SCENARIO_DETAIL_SPEC.md) | 唯一实现级详细规范：S0-S40、API 归类、独立专病路径、护理/报告/床旁知识/中医药、AI 工厂、引擎与评级 |
...
| [docs/CONSTITUTION.md](docs/CONSTITUTION.md) | 产品宪法：17 条硬约束 / 5 菜单 / 4 状态机 / 7 步流 / 6 阶段租户生命周期 |
| [docs/backlog.md](docs/backlog.md) | 单一任务台账：E1-E5 当前执行，E6 后置业务包装清单只登记不抢跑 |
