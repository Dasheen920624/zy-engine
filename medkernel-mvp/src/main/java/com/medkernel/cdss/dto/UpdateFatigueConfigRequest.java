...
/**
 * 更新疲劳配置请求 DTO：用于 CdssOverrideController.updateFatigueConfig 及 AlertFatigueController.updateConfig。
 */
@Schema(description = "更新疲劳配置请求")
public class UpdateFatigueConfigRequest {
