...
-- 初始化演示用户
MERGE INTO sec_user (id, tenant_id, username, password_hash, display_name, user_type, employee_id, status, created_by) KEY(tenant_id, username) VALUES (1001, 1, 'admin', '$2a$10$GNycXiBqR1ydr7zFjdVuKec3GoB4Y1x.YUyLK2jvhYsUTBEZlSjkC', '系统管理员', 'ADMIN', 'EMP-ADMIN-001', 'ACTIVE', 'system');
MERGE INTO sec_user (id, tenant_id, username, password_hash, display_name, user_type, employee_id, status, created_by) KEY(tenant_id, username) VALUES (1002, 1, 'zhao01', '$2a$10$GNycXiBqR1ydr7zFjdVuKec3GoB4Y1x.YUyLK2jvhYsUTBEZlSjkC', '赵医生', 'DOCTOR', 'EMP-DOC-001', 'ACTIVE', 'system');
MERGE INTO sec_user (id, tenant_id, username, password_hash, display_name, user_type, employee_id, status, created_by) KEY(tenant_id, username) VALUES (1003, 1, 'qian02', '$2a$10$GNycXiBqR1ydr7zFjdVuKec3GoB4Y1x.YUyLK2jvhYsUTBEZlSjkC', '钱护士', 'NURSE', 'EMP-NURSE-001', 'ACTIVE', 'system');
MERGE INTO sec_user (id, tenant_id, username, password_hash, display_name, user_type, employee_id, status, created_by) KEY(tenant_id, username) VALUES (1004, 1, 'sun03', '$2a$10$GNycXiBqR1ydr7zFjdVuKec3GoB4Y1x.YUyLK2jvhYsUTBEZlSjkC', '孙医保', 'INSURANCE', 'EMP-INS-001', 'ACTIVE', 'system');
MERGE INTO sec_user (id, tenant_id, username, password_hash, display_name, user_type, employee_id, status, created_by) KEY(tenant_id, username) VALUES (1005, 1, 'li04', '$2a$10$GNycXiBqR1ydr7zFjdVuKec3GoB4Y1x.YUyLK2jvhYsUTBEZlSjkC', '李信息', 'IT_ADMIN', 'EMP-IT-001', 'ACTIVE', 'system');
MERGE INTO sec_user (id, tenant_id, username, password_hash, display_name, user_type, employee_id, status, created_by) KEY(tenant_id, username) VALUES (1006, 1, 'zhou05', '$2a$10$GNycXiBqR1ydr7zFjdVuKec3GoB4Y1x.YUyLK2jvhYsUTBEZlSjkC', '周实施', 'IMPLEMENTER', 'EMP-IMP-001', 'ACTIVE', 'system');
MERGE INTO sec_user (id, tenant_id, username, password_hash, display_name, user_type, employee_id, status, created_by) KEY(tenant_id, username) VALUES (1007, 1, 'wu06', '$2a$10$GNycXiBqR1ydr7zFjdVuKec3GoB4Y1x.YUyLK2jvhYsUTBEZlSjkC', '吴院长', 'HOSPITAL_LEADER', 'EMP-LEAD-001', 'ACTIVE', 'system');
MERGE INTO sec_user (id, tenant_id, username, password_hash, display_name, user_type, employee_id, status, created_by) KEY(tenant_id, username) VALUES (1008, 1, 'zheng07', '$2a$10$GNycXiBqR1ydr7zFjdVuKec3GoB4Y1x.YUyLK2jvhYsUTBEZlSjkC', '郑专家', 'MEDICAL_EXPERT', 'EMP-EXP-001', 'ACTIVE', 'system');
MERGE INTO sec_user (id, tenant_id, username, password_hash, display_name, user_type, employee_id, status, created_by) KEY(tenant_id, username) VALUES (1009, 1, 'wang08', '$2a$10$GNycXiBqR1ydr7zFjdVuKec3GoB4Y1x.YUyLK2jvhYsUTBEZlSjkC', '王运营', 'PLATFORM_OPS', 'EMP-OPS-001', 'ACTIVE', 'system');
