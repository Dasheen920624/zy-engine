...
if (![string]::IsNullOrWhiteSpace($env:MEDKERNEL_DB_URL) -and
    ![string]::IsNullOrWhiteSpace($env:MEDKERNEL_DB_USERNAME) -and
    ![string]::IsNullOrWhiteSpace($env:MEDKERNEL_DB_PASSWORD)) {
