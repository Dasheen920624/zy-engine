...
# 6. 拷贝运维 / 备份 runbook
cp "$ROOT_DIR/docs/ops/backup-restore-runbook.md" "$WORK_DIR/docs/" 2>/dev/null || true
cp "$ROOT_DIR/docs/ops/upgrade-rollback-runbook.md" "$WORK_DIR/docs/" 2>/dev/null || true
