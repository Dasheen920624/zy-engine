...
-- 验收测试结果
CREATE TABLE qa_acceptance_test_result (
  id NUMBER(19) PRIMARY KEY,
  tenant_id NUMBER(19) NOT NULL,
  result_code VARCHAR2(64) NOT NULL,
  test_case_id NUMBER(19),
  case_code VARCHAR2(64),
  case_name VARCHAR2(200),
  feature_code VARCHAR2(64),
  category VARCHAR2(32),
  verdict VARCHAR2(16),
  actual_result CLOB,
  deviation VARCHAR2(2000),
  evidence_refs CLOB,
  ...
  status VARCHAR2(16) DEFAULT 'EXECUTED' NOT NULL,
  created_time TIMESTAMP DEFAULT SYSTIMESTAMP NOT NULL,
...
-- 验收证据
CREATE TABLE qa_acceptance_evidence (
  id NUMBER(19) PRIMARY KEY,
  tenant_id NUMBER(19) NOT NULL,
  evidence_code VARCHAR2(64) NOT NULL,
  result_code VARCHAR2(64),
  case_code VARCHAR2(64),
  evidence_type VARCHAR2(32),
  description VARCHAR2(2000),
  file_path VARCHAR2(500),
  file_hash VARCHAR2(128),
  file_size NUMBER(19) DEFAULT 0,
  mime_type VARCHAR2(128),
  captured_by VARCHAR2(64),
...
CREATE INDEX idx_qa_result_case_verdict ON qa_acceptance_test_result (tenant_id, case_code, verdict);
CREATE INDEX idx_qa_result_feature_status ON qa_acceptance_test_result (tenant_id, feature_code, status);
CREATE INDEX idx_qa_evidence_result ON qa_acceptance_evidence (tenant_id, result_code);
