...
- AGENTS.md AI 协作总纲（#170）✅：§0–§8 + 6 总纲（质量 / 证据优先 / 安全降级 / 单一真相源 / token 经济 / 重构高标准）+ 15 场景规约表，55 行精炼版；同 PR 收尾本 handoff
...
---
> 末次更新：2026-05-31 · wave2 全 55 卡已合（#168 + #169）→ **卡体系迁移 100% 完成**（D0–D6 + GA + wave2 全 113 卡，矩阵 131 锚点 + 场景 S0–S40 全覆盖）；**AGENTS.md AI 协作总纲（§0–§8 + 6 总纲 + 15 场景表，55 行）+ 本 handoff 收尾合一 PR（#170）**；已转入**执行开发阶段**（按卡 TDD 实现，非建卡）
