...
5. 在 10_task_claims/active/<claim_id>.md 和 10_task_claims/active_locks/<task_id>.lock 创建并推送任务认领
...
11. 完成后归档 claim/review 到 archive/YYYYMMDD/，并删除对应 active_locks/<task_id>.lock
```
