-- PROV-004 发布检查阻断 DDL (Oracle)

-- 发布检查清单表
CREATE TABLE prov_release_checklist (
  id NUMBER(19) PRIMARY KEY,
  tenant_id NUMBER(19) NOT NULL,
  checklist_code VARCHAR2(64) NOT NULL,
  checklist_name VARCHAR2(200) NOT NULL,
  resource_type VARCHAR2(32) NOT NULL,
  description VARCHAR2(2000),
  check_items CLOB,
  blocking_rules CLOB,
  approval_required VARCHAR2(5) DEFAULT 'FALSE',
  approval_roles VARCHAR2(500),
  enabled VARCHAR2(5) DEFAULT 'Y' NOT NULL,
...
-- 发布检查结果表
CREATE TABLE prov_release_check_result (
  id NUMBER(19) PRIMARY KEY,
  tenant_id NUMBER(19) NOT NULL,
  check_code VARCHAR2(64) NOT NULL,
  checklist_code VARCHAR2(64),
  checklist_name VARCHAR2(200),
  resource_type VARCHAR2(32) NOT NULL,
  resource_code VARCHAR2(128) NOT NULL,
  resource_version VARCHAR2(32),
  check_status VARCHAR2(16) DEFAULT 'PENDING' NOT NULL,
  check_detail CLOB,
  total_items NUMBER(10) DEFAULT 0,
  passed_items NUMBER(10) DEFAULT 0,
  failed_items NUMBER(10) DEFAULT 0,
  blocked_items NUMBER(10) DEFAULT 0,
  blocked_reason VARCHAR2(2000),
  approved_by VARCHAR2(64),
  approved_time TIMESTAMP,
  approval_note VARCHAR2(2000),
  waived_by VARCHAR2(64),
  waive_reason VARCHAR2(2000),
...
CREATE INDEX idx_prov_rc_result_tenant_status ON prov_release_check_result (tenant_id, resource_type, check_status);
CREATE INDEX idx_prov_rc_result_resource ON prov_release_check_result (tenant_id, resource_code, resource_version);
