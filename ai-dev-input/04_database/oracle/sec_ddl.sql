-- Oracle SEC DDL for user authentication and authorization
...
CREATE TABLE sec_identity_binding (
  ...
  external_subject VARCHAR2(200) NOT NULL,
...
CREATE TABLE sec_user_sync_job (
  ...
  created_count NUMBER(10) DEFAULT 0 NOT NULL,
  updated_count NUMBER(10) DEFAULT 0 NOT NULL,
  disabled_count NUMBER(10) DEFAULT 0 NOT NULL,
