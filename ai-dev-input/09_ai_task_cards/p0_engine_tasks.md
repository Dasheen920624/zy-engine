...
> 说明：本文是早期 MVP 阶段的历史任务清单，用于理解项目起点。后续产品化开发请以 `zy-engine-mvp/docs/00_总入口与AI接手导航.md` 和 `zy-engine-mvp/docs/02_任务台账.md` 为准；产品化总纲仅在范围不清时按需查阅。若任务编号或验收口径冲突，以 `00_总入口与AI接手导航.md` 的硬门禁和 `02_任务台账.md` 的状态为准。
